...
namespace BlazorOverviewShared.Pages.FormValidation
{
    public static class EditContextFluentValidationExtensions
    {
        ...
        private static void ValidateField(EditContext editContext, ValidationMessageStore messages, in FieldIdentifier fieldIdentifier)
        {
            ...
            var validationResultsError = validationResults.Errors.Select(error => error.ErrorMessage);
            foreach(var err in validationResultsError)
            {
                messages.Add(fieldIdentifier, err);
            }
